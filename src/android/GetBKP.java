...
public class GetBKP extends CordovaPlugin {
    ...
    private JSONObject getKey(JSONArray args) throws
            SignatureException, InvalidKeyException, UnsupportedEncodingException, InvalidKeySpecException, JSONException, NoSuchAlgorithmException {
        ...
        String PKP = Base64.encodeToString(rsa_text, Base64.NO_WRAP);
